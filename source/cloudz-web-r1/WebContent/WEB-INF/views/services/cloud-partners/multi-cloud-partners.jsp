        ...
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">Multi-Cloud Partners</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/sub/u0206/v01/01.png" alt="">
              </div>
            </div>
            <ul class="list big-step grid no-bullet">
              <li class="col-4">
                <h4 class="label">Amazon Web Service</h4>
                <div class="content">
                  <p>2006년 아마존닷컴에서 개발한 Cloud 컴퓨팅 플랫폼 서비스로, 전세계 Cloud 컴퓨팅 분야에서 1위의 점유율을 차지하고 있습니다.</p>
                  <p>AWS는 점유율을 바탕으로 규모의 경제 기반의 합리적인 가격, 오랜 경험을 통한 앞선 기술, 편리성 등이 장점입니다.</p>
                </div>
              </li>
              <li class="col-4">
                <h4 class="label">Microsoft Azure</h4>
                <div class="content">
                  <p>전세계 2위 점유율의 MS Azure는 글로벌 리전을 빠르게 확장내 나가며, 140개국에 서비스를 제공하고 있습니다.</p>
                  <p>Azure는 Windows와 MS사의 소프트웨어를 사용하고 있는 많은 조직과 기업에 익숙한 환경의 Cloud를 사용할 수 있다는 것이 가장 큰 장점입니다.</p>
                </div>
              </li>
              <li class="col-4">
                <h4 class="label">Google Cloud Platform</h4>
                <div class="content">
                  <p>TensorFlow, Kubernetes 등의 오픈소스 및 개발자 친화적인 환경을 선도하고 있으며, 특히 Cloud와 연계하여 AI/Big Data 플랫폼 관련 원천 기술을 보유하고 있습니다.</p>
                  <p>Enterprise IaaS와 Data Analytics를 함께 연계하고자 할 때 큰 장점을 가지고 있습니다.</p>
                </div>
              </li>
              <li class="col-4">
                <h4 class="label">Naver Cloud Platform</h4>
                <div class="content">
                  <p>국내 최대 IT 서비스를 운영하는 Naver의 Cloud Service입니다.</p>
                  <p>국내의 안정적인 IT 인프라 환경과 한글로 설명된 상세 가이드, 우리에게 친숙한 Naver UI 환경과 유사한 콘솔을 사용하기 때문에 사용이 어렵지 않다는 강점이 있습니다.</p>
                </div>
              </li>
              <li class="col-4">
                <h4 class="label">IBM Cloud</h4>
                <div class="content">
                  <p>IBM은 오랜 경험에 기반한 Enterprise 중심 비즈니스에 대한 이해도를 바탕으로 전문적인 Enterprise Cloud 서비스를 제공합니다.</p>
                  <p>‘Red Hat’ 인수 등 선도적 Hybrid Cloud 역량을 확보하였고, 기업의 DT기술을 기존 기업시스템과 Cloud에서 함께 이용하고자 할 때 강점이 있습니다.</p>
                </div>
              </li>
              <li class="col-4">
                <h4 class="label">Alibaba Cloud</h4>
                <div class="content">
                  <p>Alibaba Cloud는 2009년 설립 이후 중국 뿐 아니라, 전 세계에 Region을 보유하고, 글로벌 서비스를 제공합니다.</p>
                  <p>특히 중국 네트워크 안전법, 보안등급 2.0 표준 등 중국 정부가 요구하는 법규를 준수하며 Cloud 서비스를 활용하도록 지원하고, 중국 주요 통신사와 전용선으로 연계하여 중국 내 주요 지역을 매우 빠르게 연결합니다.</p>
                </div>
              </li>
            </ul>
          </div>
                    ...
                    <li>
                      <div class="content-item">
                        <div class="content-item-body">
                          <div class="list-box content">
                            <div class="list-box-content">
                              <h4 class="list-label">Microsoft Azure</h4>
                              <ul class="list dot">
