...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main" data-page="biz-tools">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/biz-tools/header_01.png');">
      </div>
    ...
    <div class="entry-content">
      <div class="banner-card-wrap inner-wrap">
        <a href="/services/cloud-marketplace/biz-tools/integrated-message" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/biz-tools/u02_07-t06-02.png" alt="integrated-message">
          </div>
          <div class="text-box">
            <div class="title">비즈메시지 - 통합메시지</div>
            <div class="desc">별도의 솔루션 구매나 서버 구축 없이 유형의 메시지를 <br />다양한 채널을 통해 발송가능한 통합 메시지 발송 서비스입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/biz-tools/kakao-message-text" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/biz-tools/u02-07-t06-03.png" alt="kakao-message-text">
          </div>
          <div class="text-box">
            <div class="title">비즈메시지 - 카카오메시지/문자</div>
            <div class="desc">카카오톡으로 바로 보내는 광고형 비즈메시징 서비스를 <br />지원하는 통합메시지 발송 서비스(UMS) 입니다.</div>
          </div>
        </a>
      </div>
    </div>
