      ...
      <div class="section">
        <div class="inner-wrap">
          <header class="section-header mg-0">
            <h2 class="title">Mission Critical 업무를 위해 최상위 Support Plan 서비스를 제공합니다.</h2>
            <p>SK는 Cloud 운영 중에 발생하는 기술 문의나 장애 대응을 위한 Support 및 Escalation 체계를 갖고 있으며, Cloud 공급사의 전문 기술 지원이 필요한 경우 Support Plan을 CSP와 Partnership을 통해 합리적인 가격으로 제공합니다. 최상위 Support Plan의 제공은 물론 연중무휴 24시간 전화, 이메일 및 채팅 액세스가 가능합니다.</p>
          </header>
        </div>
      </div>
      <div class="section">
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">Support Plan</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/sub/u0204/v05/01.png" alt="">
              </div>
            </div>
            <ul class="list big-step">
              <li>
                <h4 class="label">전담 기술지원 체계 운영</h4>
                <div class="content">
                  <p>전담 기술 지원 관리자가 고객의 Mission Critical Workload 이슈 해결을 지원합니다.</p>
                  <p>고객 Industry에 대한 이해도를 바탕으로 장애 발생 시 신속하게 전문가를 배정하고 문제 해결을 위한 역할을 수행합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Business Review 지원</h4>
                <div class="content">
                  <p>CSP와의 정기적인 Service Review를 지원합니다.</p>
                  <p>품질관리, 신기술 공유, 비용 분석 및 최적화, 운영 이슈 심층 분석 등의 Review 서비스를 제공하여 고객의 Cloud journey에 도움이 되고자 합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Self Service 역량 강화 지원</h4>
                <div class="content">
                  <p>고객이 장애를 사전에 예방하기 위하여 온라인 자습형 실습 환경을 제공합니다.</p>
                  <p>Well-Architected를 검토하고, 이슈 발생 전 워크숍 및 심층 분석 서비스를 진행합니다.</p>
                </div>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0204/v05/02.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">신속한 장애 해결</h4>
                    <p>Support Portal에 접수된 장애나 이슈의 경우 L1,L2 엔지니어가 해결하기 어려운 문제 티켓은 즉시 CSP로 Escalation이 가능합니다. </p>
                    <p>Multi-Cloud 통합 대응 체계의 연중 무휴 고객 지원으로 서비스 영향을 최소화 합니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco top-left w-50p">
                    <img src="/assets/imgs/sub/u0204/v05/03.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">품질 &amp; 운영효율성 증대</h4>
                    <p>Enterprise 고객의 다양한 서비스에 대한 높은 수준의 이해를 바탕으로 효율적인 통합 운영이 가능합니다.</p>
                    <p>Cloud Managed Service 경험을 전파하여 운영 효율성을 높일 수 있습니다.</p>
                    <p>Cloud 공급사와 Premium Partnership으로 다양한 유형의 장애 발생 시 신속한 원인 파악 및 조치가 가능합니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0204/v05/04.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">합리적인 가격의 서비스</h4>
                    <p>Multi-Cloud의 Support Plan을 기반으로 구성되어 있으며, 고객에게 Premium 서비스를 합리적인 가격으로 제공합니다.</p>
                    <p>Cloud Z Support 체계와 Knowledge DB를 활용하여 고객이 직접 기술 지원 서비스를 신청 하는 것보다 빠른 문제 해결이 가능하고 시너지 효과를 누릴 수 있습니다.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="product-list">
                <div class="product-list-item">
                  <div class="product-list-header">
                    <span class="label">SK Support for AWS</span>
                  </div>
                  <div class="product-list-content">
                    <ul class="list dot">
                      <li>24x7 기술 지원</li>
                      <li>고객/MSP Ticket 작성 가능</li>
                      <li>5단계 Ticket 대응 (15분~24시간)</li>
                      <li>전담 TAM 지원</li>
                    </ul>
                  </div>
                </div>
                <div class="product-list-item">
                  <div class="product-list-header">
                    <span class="label">SK Support for Azure</span>
                  </div>
                  <div class="product-list-content">
                    <ul class="list dot">
                      <li>24x7 포괄적 MS기술지원</li>
                      <li>Azure 및 MS 전반 지원 전담 팀에 의한 고객 관리</li>
                      <li>대응 시간 1~4시간</li>
                      <li>Mission Critical 장애 ARR 옵션 추가 시 15분 이내, 솔루션 검증 및 아키텍처 리뷰, 최우선 Escalation</li>
                    </ul>
                  </div>
                </div>
                <div class="product-list-item">
                  <div class="product-list-header">
                    <span class="label">SK Support for IBM</span>
                  </div>
                  <div class="product-list-content">
                    <ul class="list dot">
                      <li>24x7 기술 지원, 심각도별 15분~4시간 이내</li>
                      <li>전담 TAM 지정 및 전문가 컨설팅</li>
                      <li>QBR(Quarterly Business Review) 보고</li>
                      <li>SK Resell 고객은 무상 제공</li>
                    </ul>
                  </div>
                </div>
              </div>
