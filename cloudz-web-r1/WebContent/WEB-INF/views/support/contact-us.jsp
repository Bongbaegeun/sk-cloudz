  ...
  <div class="container support">
    <div class="entry-header">
      <header class="sub-header">
        ...
        <div class="sub-bg">
          <img src="/assets/imgs/sub/support/header.png" alt="">
        </div>
      </header>
    </div>
    <div class="entry-content">
      <div class="section support-header">
        <div class="inner-wrap">
          <div class="heading-msg">
            <h3 class="label">Cloud Z에 대한 요청 혹은 궁금증은<br>Support Portal에 접속하여 작성해주세요.</h3>
            <div class="msg">
              <a href="https://support.skdt.co.kr" target="_blank">https://support.skdt.co.kr</a>
              <p>회원/비회원 모두 이용 가능합니다!</p>
            </div>
            <a href="https://support.skdt.co.kr" target="_blank" class="button">상담/문의 하기</a>
          </div>
          <div class="heading-img">
            <img src="/assets/imgs/sub/support/guide/support-guide-img.png" alt="">
          </div>
        </div>
      </div>
      <div class="section support-guide">
        <div class="inner-wrap">
          <div class="support-guide-content">
            <div class="guide-header">
              <h3>Support Portal 이용방법 안내</h3>
            </div>
            <div class="guide-body">
              <div class="guide-section">
                <div class="guide-desc">
                  <h3>1. Support Portal에 접속합니다.</h3>
                  <ul class="list dot">
                    <li>브라우저를 통해 Support Portal(<a href="https://support.skdt.co.kr" target="_blank">https://support.skdt.co.kr</a>)에 접속합니다.(Chrome 계열 브라우저에 최적화되어 있습니다.)</li>
                  </ul>
                </div>
                <div class="guide-img">
                  <img src="/assets/imgs/sub/support/guide/support-guide-01.png" alt="">
                </div>
              </div>
              <div class="guide-section">
                <div class="guide-desc">
                  <h3>2. Support Portal에 가입해주세요.</h3>
                  <ul class="list dot">
                    <li>Support Portal 오른쪽 상단의 [가입]을 클릭합니다.</li>
                    <li>사용자의 이름과 업무용 이메일을 입력합니다. 등록된 이메일은 로그인 ID로 사용되며, 해당 이메일로 요청한 티켓의 상태 및 결과에 대한 알림 메일이 발송됩니다.<br>※ 봇 (Bot) 접근 제어를 위한 적절한 이미지 선택 후 등록을 클릭합니다.</li>
                  </ul>
                </div>
                <div class="guide-img">
                  <img src="/assets/imgs/sub/support/guide/support-guide-02.png" alt="">
                </div>
              </div>
              <div class="guide-section">
                <div class="guide-desc">
                  <h3>3. 이메일로 안내된 링크를 클릭하세요</h3>
                  <ul class="list dot">
                    <li>입력한 이메일로 Support Portal 사용자 등록 메일이 발송됩니다. 이메일로 안내된 링크를 클릭하여 Support Portal 로그인 시 사용할 비밀번호를 등록합니다. </li>
                    <li>만약 사용자 등록 확인 메일을 받지 못하였다면 스팸 메일로 분류되었는지 확인해보시기 바랍니다.</li>
                  </ul>
                </div>
                <div class="guide-img">
                  <img src="/assets/imgs/sub/support/guide/support-guide-03.png" alt="">
                </div>
              </div>
              <div class="guide-section">
                <div class="guide-desc">
                  <h3>4. Support Portal에서 티겟을 작성합니다.</h3>
                  <ul class="list dot">
                    <li>사용자 등록 완료 후 Support Portal 메인 화면에서 오른쪽 상단의 로그인을 클릭하여 이메일 및 비밀번호를 입력합니다.</li>
                    <li>메인 화면에서 ‘신규 티켓 작성’을 눌러 티켓을 작성합니다.</li>
                  </ul>
                </div>
                <div class="guide-img">
                  <img src="/assets/imgs/sub/support/guide/support-guide-04.png" alt="">
                </div>
              </div>
              <div class="guide-section">
                <div class="guide-desc">
                  <h3>5. 비회원으로 문의사항을 등록하실 경우</h3>
                  <ul class="list dot">
                    <li>가입 여부에 무관하게 요청사항을 등록할 수 있습니다.</li>
                    <li>Support Portal 메인 화면에서 ‘신규 티켓 작성’을 눌러 티켓 작성 화면으로 이동합니다.</li>
                    <li>개인정보수집이용동의서를 확인하고 약관에 동의 후 티켓을 작성합니다.</li>
                  </ul>
                </div>
                <div class="guide-img">
                  <img src="/assets/imgs/sub/support/guide/support-guide-05.png" alt="">
                </div>
              </div>
            </div>
          </div>
