...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/sk-cnc.css">
</head>
...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container about">
    <div class="entry-header">
      <header class="sub-header">
        <div class="inner-wrap">
          <h2 class="text-center">SK주식회사 C&amp;C의 역량</h2>
        </div>
    ...
    <div class="entry-content">
      <div class="section text-center pd-bottom-2x">
        <div class="inner-wrap">
          <header class="section-header pg-bottom-0">
            <h2 class="title">SK주식회사 C&amp;C의 공인 Certificate와<br>Competency를 소개합니다.</h2>
          </header>
        </div>
      </div>
      <div class="section">
        <div class="inner-wrap">
          <div id="landing" class="loading">
          ...
          <ul id="tabNav" class="tab-nav d-flex mg-bottom-6x">
          </ul>
          <div id="tabList">
          </div>
        </div>
  ...
  <script src="/assets/js/sk-cnc.js"></script>
</body>
