          ...
          <div class="notice detail">
            <div class="notice-detail">
              <div class="notice-header">
                <h3><span class="tag">공지</span> Cloud Z 홈페이지는 Chrome/Edge/Safari에 최적화되어 있습니다.</h3>
                <span class="date">2021.09.30</span>
              </div>
              <div class="notice-body">
                <p>안녕하세요. Cloud Z입니다.</p>
                <p>&nbsp;</p>
                <p>Cloud Z 사이트는 Chrome(구글 크롬), Edge(마이크로소프트 엣지), Safari(애플 사파리)에 최적화되어 있습니다. </p>
                <p>&nbsp;</p>
                <p>IE(인터넷 익스플로러) 브라우저에서는 정상적으로 작동하지 않을 수 있으므로, 화면이 온전하지 않은 경우 Chrome 또는 Edge로 접속하시면 원활히 보실 수 있습니다. </p>
                <p>&nbsp;</p>
                ...
                <div class="notice-nav">
                  <div class="notice-link prev-link">
                    <div class="link">
                      ...
                      <a href="/support/notice-01">Cloud Z 홈페이지 개편에 따른 일부 기능 변경 안내</a>
                    </div>
                  </div>
