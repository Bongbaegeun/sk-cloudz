  ...
  <div class="container partners">
    <div class="entry-header">
      <header class="sub-header">
        <div class="inner-wrap">
          <h2 class="text-center">파트너사 되기</h2>
        </div>
      ...
      <section class="section">
        <div class="inner-wrap">
          <header class="section-header text-center">
            <h2 class="title">파트너사 되기</h2>
            <p>SK주식회사 C&amp;C와 함께 고객의 성공과 새로운 가치를 공유할 수 있는 사업 파트너를 찾습니다.</p>
          </header>
          <div class="section-body">
            <ul class="grid col-3">
              <li>
                <div class="card guide-card reseller">
                  <div class="guide-header">
                    <h3>Reseller</h3>
                    <p>SK주식회사의 Cloud Z 서비스를<br>재판매할 파트너를 찾습니다.</p>
                  </div>
                  <div class="guide-body">
                    <div class="guide-detail">
                      ...
                      <ul class="list dot">
                        <li>제휴 신청</li>
                        <li>Cloud Z 담당자 검토</li>
                        <li>제휴 확정 및 별도 제휴절차 진행</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <li>
                <div class="card guide-card isv">
                  <div class="guide-header">
                    <h3>ISV</h3>
                    <p>SK주식회사와 SaaS시장을 개척할<br>Independent Service Vender를 찾습니다.</p>
                  </div>
                  <div class="guide-body">
                    <div class="guide-detail">
                      <h4>ISV 제휴 방식</h4>
                      <ul class="list dot">
                        <li>Share형: SaaS 상품 공동 개발, 수익배분</li>
                        <li>동반성장형: ISV가 자체 솔루션과 IaaS를 묶어 고객에게 제공</li>
                        <li>구매형: Cloud Z가 ISV 솔루션을 구매하여 SaaS 상품으로 판매</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <li>
                <div class="card guide-card msp">
                  <div class="guide-header">
                    <h3>MSP</h3>
                    <p>Cloud Z 관리서비스를 제공할<br>Managed Service Provider를 찾습니다.</p>
                  </div>
                  <div class="guide-body">
                    <div class="guide-detail">
            ...
            <div class="text-center mg-top-6x">
              <a href="https://support.skdt.co.kr/ko/support/tickets/new" class="button blue round partnership-contact" target="_blank"><span class="label">파트너 제휴 문의</span><i class="xi-long-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </section>
