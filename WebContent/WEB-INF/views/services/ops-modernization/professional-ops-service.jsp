  ...
  <div class="container">
    <div class="entry-header">
      <header class="sub-header">
        <div class="inner-wrap">
          <h2>Professional Ops Service</h2>
      ...
      <div class="section">
        <div class="inner-wrap">
          <header class="section-header mg-0">
            <h2 class="title">Efficiency를 넘어 Resilience를 지향하는 IT 운영을 추구합니다.</h2>
            <p>급변하는 비즈니스 환경에서 기존의 IT 운영 방식은 더 이상 지속 가능하지 않으며 기업의 경쟁 우위 확보를 지원하기 위해 무엇이 달라져야 하는지 깊은 고민과 함께 민첩한 실행이 요구됩니다. Professional Ops Service는 고객과 함께 IT 주도의 비즈니스 혁신을 지원하는 Ops Modernization을 실현합니다.</p>
          </header>
        </div>
      </div>
      <div class="section">
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">Professional Ops Service</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/sub/u0202/v05/01.png" alt="">
              </div>
            </div>
            <ul class="list big-step">
              <li>
                <h4 class="label">Rich Experience</h4>
                <div class="content">
                  <p>다양한 산업의 Multi/Hybrid Cloud 운영 경험과 자체 운영 체계를 통한 전문성을 바탕으로 Cloud 환경 기반의 IT 운영 노하우를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Operation Focus</h4>
                <div class="content">
                  <p>인프라 환경 변화에 따른 Cloud Scale Ops로의 전환은 피할 수 없는 과제이며 이를 위해 IT 운영 프로세스와 도구에 특화된 전문 서비스를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Operational Substantiation</h4>
                <div class="content">
                  <p>현황분석을 통해 개선 방안을 제시하는 이론적 방법론에서 나아가 제시된 컨셉의 실증적 검증을 통해 실제 운영에 가져올 효과를 확인할 수 있습니다.</p>
                </div>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0202/v05/02.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">운영 효율성 확보</h4>
                    <p>운영자들은 수작업 또는 중복작업으로 인해 불필요하거나 중요하지 않은 영역에 에너지를 낭비하곤 합니다. </p>
                    <p>자동화된 도구와 기능을 활용하면 보다 가치 있는 업무에 운영 리소스를 할애할 수 있어 사용자 경험을 혁신하고 개선할 수 있는 기회를 확보할 수 있습니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco top-left w-50p">
                    <img src="/assets/imgs/sub/u0202/v05/03.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">변화에 유연한 대처</h4>
                    <p>최근의 IT 운영 환경은 급변하는 비즈니스 환경에 대응하기 위해 민첩성 · 유연성을, 복잡하고 다양한 기술의 수용을 위해 신뢰성 · 확장성을 요구합니다.</p>
                    <p>이러한 진보된 운영 환경을 보유한 기업은 새로운 기술의 수용과 변화하는 사용자 요구를 충족하거나 초과할 수 있습니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0202/v05/04.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">향상된 위험 관리</h4>
                    <p>운영상의 위험은 명확한 원칙, 역할, 책임 및 프로세스와 적절한 운영 도구의 부재로 인해 증가하거나 지속됩니다.</p>
                    <p>보다 빠르게 문제를 인지하고 필요한 인력·조직과 적시에 상황을 공유 및 대처하여 심각한 사고로의 발전을 막아 비즈니스의 연속성을 보장할 수 있습니다.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="content-box">
              <div class="row">
                ...
                <div class="row-content block">
                  <p>Multi/Hybrid Cloud 기반 IT 시스템을 운영하는 고객의 전체적인 운영 환경을 분석하며 인지/전파/조치 관점에서 운영 체계를 중점적으로 점검하는 것을 목표로 합니다. </p>
                  <ul class="grid col-2">
                    <li>
                      <div class="fill-box">
              ...
              <div class="row">
                ...
                <div class="row-content block">
                  <p>고객의 현재 운영 환경의 분석 데이터를 기반으로 요구사항을 충족하고 지속적으로 변화하는 환경에 유연하게 대응할 수 있는 진보된 운영 환경을 제시합니다.</p>
                  <ul class="grid col-2">
                    <li>
                      <div class="fill-box">
              ...
              <div class="row">
                ...
                <div class="row-content block">
                  <p>제시된 운영모델 및 환경구성 방안을 실험적 수행을 통해 그 효과와 효용성을 실질적이고 직관적으로 사전에 검증할 수 있도록 지원합니다.</p>
                  <ul class="grid col-2">
                    <li>
                      <div class="fill-box">
          ...
          <div class="section-body">
            <div class="content-box x-axis">
              <div class="row content-row">
                ...
                <div class="row-content">
                  <ul class="list dot">
                    <li>2년 내 모든 On-Premise 인프라를 <strong>Cloud 서비스로 전환</strong>하여야 했습니다.</li>
                    <li>Cloud 서비스로의 전환과 함께 <strong>IT 운영 환경의 현대화를 달성</strong>해야 했습니다.</li>
                  </ul>
                </div>
                ...
                <div class="row-content">
                  <ul class="list dot">
                    <li>현행 업무 및 Hybrid Cloud 환경을 모두 지원하는 통합 모니터링의 표준 환경 구현이 필요했습니다.</li>
                    <li>다양한 서비스, 애플리케이션 및 인프라의 실시간 연계 분석을 통한 신속한 조치 지원이 필요했습니다.</li>
                    <li>Cloud 전환 과정에서 필요한 ‘Right Sizing 지표’ 확보가 중요했습니다. </li>
                  </ul>
                  <div class="fill-box w-100p">
                    <ul class="list dot">
                      <li>IT 환경 전반의 가시성 확보를 위한 To-Be 모니터링 체계를 수립했습니다.</li>
                      <li>On-Premise 및 Cloud 환경에서 운용 중인 주요 시스템을 대상으로 통합된 Hybrid Cloud 모니터링 PoC를 수행했습니다.</li>
                      <li>PoC 결과를 기반으로 Cloud 전환과 Align된 모니터링 고도화 계획을 수립했습니다.</li>
                    </ul>
                  </div>
                </div>
                <div class="deco-line"></div>
                ...
                <div class="row-content">
                  <ul class="list dot">
                    <li>Cloud 전환 과정을 온전히 지원하는 <strong>표준 모니터링 체계를 확보</strong>했습니다.</li>
                    <li>불필요한 수작업 감소 및 문제 발생 전 이상현상 인지 향상으로 <strong>운영 효율성 검증 및 End user의 IT 환경 만족도를 제고</strong>하였습니다.</li>
                    <li>자원 효율화 및 탄력적 자원 관리에 필요한 <strong>정확하고 객관적인 근거</strong>를 확보하였습니다.</li>
                  </ul>
                </div>
              </div>
              <div class="row">
