...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main" data-page="developer-tools">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/developer-tools/header_01.png');">
      </div>
    ...
    <div class="entry-content">
      <div class="banner-card-wrap inner-wrap">
        <a href="/services/cloud-marketplace/developer-tools/static-source-analysis-sonarqube" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/developer-tools/img-u02-07-t04-02.png" alt="static-source-analysis-sonarqube">
          </div>
          <div class="text-box">
            <div class="title">정적소스코드 분석-SonarQube</div>
            <div class="desc">소스 코드의 리스크를 분석하여 취약점을 탐지하고, 발견된 문제를 해결함으로써 <br />소프트웨어 품질 목표를 달성할 수 있도록 지원합니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/developer-tools/static-source-analysis-coverity" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/developer-tools/img-u02-07-t04-03.png" alt="static-source-analysis-coverity">
          </div>
          <div class="text-box">
            <div class="title">정적소스코드 분석-Coverity</div>
            <div class="desc">소스 코드의 지속적인 탐지와 빠른 분석을 통해 <br />다양한 언어의 소프트웨어 품질 목표를 달성할 수 있도록 지원하는 솔루션 입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/developer-tools/open-source-security-verification" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/developer-tools/img-u02-07-t04-04.png" alt="open-source-security-verification">
          </div>
          <div class="text-box">
            <div class="title">오픈소스 보안검증</div>
            <div class="desc">오픈소스의 License Issue 및 보안 취약점 관리에 최적화된 도구로서<br />오픈소스 컴플라이언스와 거버넌스 수립에 도움이 됩니다.</div>
          </div>
        </a>
      </div>
    </div>
