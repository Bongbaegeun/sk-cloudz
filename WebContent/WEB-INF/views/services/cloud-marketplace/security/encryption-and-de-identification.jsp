  ...
  <div class="container sub">
    <div class="entry-header">
      ...
      <header class="sub-header">
        <div class="inner-wrap">
          <h2>개인정보 암호화 및 비식별화</h2>
          <p> 개인정보 비식별화 기능을 통해 개인정보를 안전하게 이용할 수 있으며, 정형 및 비정형 데이터에 대한 <br /> 암호화를 실현하는 Vormetric 솔루션으로 기존 환경 변경없이 실시간 암호화 기능을 제공합니다. </p>
        ...
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">개인정보 암호화 및 비식별화</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-02.png">
              </div>
            </div>
            <div class="content-box">
              <h1>개인정보 암호화 및 비식별화 서비스가 필요한 Case</h1>
              <ul class="list dot">
                <li>프로그램 본수 , 플랫폼 종류 , 개발자 M/M 등 산정 등 다양한 형태의 데이터 암호화가 필요한 경우</li>
                <li>암호화 이후 서비스 영향도를 고려할 경우(속도 저하, 어플리케이션 간의 호환성 이슈 등)</li>
                <li>다양한 형태의 정형/비정형 데이터 암호화를 일괄 암호화 하고 중앙 관리가 필요한 경우</li>
                <li>개인정보보호법, ISMS 및 주요 인증심사 및 감사 대응이 필요한 경우</li>
                <li>암호화가 아닌 비식별화로 데이터를 가명화 처리 또는 마스킹 처리가 필요한 경우</li>
                <li>암호화 키를 직접 관리해야 하는 경우(클라우드 관리자도 접근 불가)</li>
              </ul>
              <div class="grid col-1 gray-block has-border mg-top-2x">
                <li class="grid-item">
                  <div class="content-item pd-left-6x">
                    <p> * 개인정보 암호화<br /> 개인정보는 데이터베이스 뿐만 아니라 시스템 상에서 전자적으로 저장되는 모든 데이터는 법적 암호화 필수입니다.<br /> - 주요 대상 (DBMS , 텍스트, 녹취 파일, 영상파일, 음성파일, 각종 문서 등) </p>
                    <p class="mg-top-2x"> * 개인정보 비식별화<br /> 개인 정보의 일부 또는 전부를 삭제·대체 하거나 다른 정보와 쉽게 결합하지 못하도록 하여 특정 개인을 알아볼 수 없도록 하는 일련의 조치 입니다.<br /> 공공정보의 개방·공유 및 빅데이터 활용 가치가 증대되는 환경 속에서 개인정보를 안전하게 이용 할 수 있도록 지원합니다. </p>
                  </div>
                </li>
              </div>
            </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-03.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">고성능 암호화</h4>
                    <p> OS 커널에 설치되어 기존 운영환경에 변경 없이 고성능의 암호화 제공 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco w-50p  top-left">
                    <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-04.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">모든 DBMS/File 암호화</h4>
                    <p> 모든 RDBMS, NoSQL, HANA SAP 암호화 지원과 로그, 이미지, 녹취, Text로 저장되는 모든 데이터에 대한 암호화 지원 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-06.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">비식별화(가명화)</h4>
                    <p> 토큰서버를 통해 민감정보 및 개인정보에 대한 가명화 및 데이터 마스킹을 제공 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco w-50p  top-left">
                    <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-07.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">안전한 키 관리</h4>
                    <p> 국제 규격을 준수하며 해외 주요 밴더들과의 전략적인 파트너쉽을 통한 안전한 키 관리 지원 </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="content-box">
              <div class="grid col-2">
                <li class="grid-item w-100p">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">커널 방식의 파일 암호화</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>어플리케이션 로직 수정 불필요</li>
                        <li>키 관리와 통합된 안전한 암호화</li>
                        <li>세분화된 접근 통제 : 허용된 사용자 또는 프로세스에 대해서만 복호화 가능, root 등 시스템 관리자 계정 차단</li>
                        <li>빅데이터, 컨테이너, 데이터베이스, 비정형 데이터 암호화 지원</li>
                        <li>타사 SIEM 솔루션과의 손쉬운 연동을 통해 부적절한 접근 탐지</li>
                      </ul>
                      <div class="img-box">
                        <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-08.png" alt="">
                      </div>
                    </div>
                  </div>
                </li>
                <li class="grid-item w-100p">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">토큰화 및 실시간 마스킹</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>에이전트 배포가 불필요하며, 어플리케이션 서버에서 VTS 와의 TCP 통신(RESTful on TLS)을 통해 동작</li>
                        <li>일반 암호화, 랜덤 토큰화 및 FPE 지원</li>
                        <li> 다양한 데이터 타입 지원<br /> - Number, Alphanumeric, Date<br /> - 2 Byte characters<br /> - 신용카드번호의 LUHN 체크 지원 </li>
                        <li>계정 권한에 따라 실시간 마스킹</li>
                      </ul>
                      <div class="img-box">
                        <img src="/assets/imgs/marketplace/security/u02-07-t01-v06-09.png" alt="">
                      </div>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">데이터 암/복호화</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>커널 방식 암호화</li>
                        <li>최적의 성능 보장</li>
                        <li>Application 소스코드 무수정</li>
                        <li>실시간 암호화 구축(다운 타임 없는 암호화 구축)</li>
                      </ul>
                    </div>
                  </div>
                </li>
                ...
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">인증</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>FIPS 140-2 Level 2, 3</li>
                        <li>국제 CC (Assurance Level: PP Compliant)</li>
                        <li>KCMVP(암호화 모듈 인증)</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">다양한 포맷 지원</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>RDBMS, NoSQL, HANA SAP</li>
                        <li>텍스트(로그, SAM, 배치파일)</li>
                        <li>이미지파일</li>
                        <li>음성파일 / 영상파일</li>
                      </ul>
                    </div>
