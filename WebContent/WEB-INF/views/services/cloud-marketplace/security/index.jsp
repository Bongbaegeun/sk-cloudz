...
<head>
  ...
  <link rel="stylesheet" href="/assets/marketplace/main.css">
</head>
...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main" data-page="security">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/security/header_01.png');">
      </div>
      ...
      <div class="navbar-wrap">
        <ul id="MktTopNavbar" class="navbar">
          <li class="nav-item" data-sid="2.7.1">
            <a href="/services/cloud-marketplace/security" data-name="security">
              <span class="label">Security</span>
            </a>
          </li>
          <li class="nav-item" data-sid="2.7.2">
            <a href="/services/cloud-marketplace/network" data-name="network">
              <span class="label">Network</span>
            </a>
          </li>
          <li class="nav-item" data-sid="2.7.3">
            <a href="/services/cloud-marketplace/management" data-name="management">
              <span class="label">Management</span>
            </a>
          </li>
          <li class="nav-item" data-sid="2.7.4">
            <a href="/services/cloud-marketplace/developer-tools" data-name="developer-tools">
              <span class="label">Developer Tools</span>
            </a>
          </li>
          <li class="nav-item" data-sid="2.7.5">
            <a href="/services/cloud-marketplace/database" data-name="database">
              <span class="label">Database</span>
            </a>
          </li>
          <li class="nav-item" data-sid="2.7.6">
            <a href="/services/cloud-marketplace/biz-tools" data-name="biz-tools">
              <span class="label">Biz Tools</span>
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="entry-content">
      <div class="banner-card-wrap inner-wrap">
        <a href="/services/cloud-marketplace/security/integrated-server-security" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-02.png" alt="integrated-server-security">
          </div>
          <div class="text-box">
            <div class="title">통합서버보안 AV/IPS</div>
            <div class="desc">Cloud 환경에서 강력한 통합 보안 기능을 제공하는<br />Host 기반 통합 보안 솔루션입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/ips-security-control-service" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-03.png" alt="ips-security-control-service">
          </div>
          <div class="text-box">
            <div class="title">IPS 보안관제</div>
            <div class="desc">PS 로그 분석을 통해 실시간 서비스를 제공하는 <br />Host 기반의 IPS 보안 관제 서비스입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/web-firewall-wapples" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-04.png" alt="web-firewall-wapples">
          </div>
          <div class="text-box">
            <div class="title">웹방화벽-WAPPLES</div>
            <div class="desc">지능형 웹방화벽으로 비정상 접근 및 공격을 탐지하여 <br />웹 애플리케이션의 보안을 강화 할 수 있습니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/web-firewall-deepfinder" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-05.png" alt="web-firewall-deepfinder">
          </div>
          <div class="text-box">
            <div class="title">웹방화벽-DeepFinder</div>
            <div class="desc">웹 서버 내 필터 동작으로 성능 저하 없이 보안의 편의성과 <br />연속성을 유지 할 수 있는 웹 애플리케이션 방화벽입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/system-access-control" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-06.png" alt="system-access-control">
          </div>
          <div class="text-box">
            <div class="title">시스템 접근 통제</div>
            <div class="desc">보안대상 시스템에 사용자의 권한별 시스템 접근통제 <br />및 작업 이력 감사 등을 수행하는 솔루션입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/encryption-and-de-identification" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-07.png" alt="encryption-and-de-identification">
          </div>
          <div class="text-box">
            <div class="title">개인정보 암호화 및 비식별화</div>
            <div class="desc">정형 및 비정형 데이터에 대한 암호화를 실현하는 Vormetric <br />솔루션으로 기존 환경 변화없는 실시간 암호화 기능을 제공합니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/ssl-secure-server-certificate" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-08.png" alt="ssl-secure-server-certificate">
          </div>
          <div class="text-box">
            <div class="title">SSL 보안서버 인증서</div>
            <div class="desc">사용자의 PC와 웹서버 간에 인터넷을 통해 송수신되는 <br />정보를 암호화하여, 정보 유출의 위험을 제거할 수 있습니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/security/webshell-detection" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/security/img-u02-07-t01-09.png" alt="webshell-detection">
          </div>
          <div class="text-box">
            <div class="title">Webshell 탐지</div>
            <div class="desc">인공지능 MLI 웹쉘 탐지 엔진을 통해 신변종 웹쉘을 <br />실시간 탐지하여 선제적 대응이 가능한 보안 솔루션입니다.</div>
          </div>
        </a>
      </div>
    </div>
  ...
  <script src="/assets/marketplace/common.js"></script>
