...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main" data-page="network">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/network/header_01.png');">
      </div>
    ...
    <div class="entry-content">
      <div class="banner-card-wrap inner-wrap">
        <a href="/services/cloud-marketplace/network/cdn" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/network/img-u02-07-t01-02.png" alt="cdn">
          </div>
          <div class="text-box">
            <div class="title">CDN</div>
            <div class="desc">SK 브로드밴드 CDN으로 고객에게 더욱 빠르고 안정적인 글로벌 콘텐츠<br />전송 서비스를 제공합니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/network/global-accelerator" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/network/img-u02-07-t01-03.png" alt="global-accelerator">
          </div>
          <div class="text-box">
            <div class="title">Global Accelerator</div>
            <div class="desc">고객이 고품질의 글로벌 가속 서비스를 보다 쉽게 사용할 수 있도록 지원합니다.</div>
          </div>
        </a>
      </div>
    </div>
