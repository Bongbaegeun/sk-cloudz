  ...
  <div class="container sub">
    <div class="entry-header">
      ...
      <header class="sub-header">
        <div class="inner-wrap">
          <h2>CDN</h2>
          <p>SK브로드밴드 CDN으로 고객에게 더욱 빠르고 안정적인 글로벌 컨텐츠 전송 서비스를 제공합니다.</p>
          <div class="sub-gnb"></div>
        </div>
      </header>
    </div>
    <div class="entry-content">
      <!-- SECTION START: 콘텐츠 헤더 -->
      <div class="section">
        <div class="inner-wrap">
          <h1 class="big-title"> 고품질 광대역 네트워크 인프라를 갖춘 CDN으로<br /> 빠르고 안정적인 글로벌 콘텐츠 전송 서비스를 제공합니다. </h1>
          <p class="sub-text"> SK 브로드밴드 CDN(Contents Delivery Network)은 광대역 네트워크 Infra와 향상된 B2B 미디어 플랫폼을 통해 고객에게 최적의 인터넷 서비스를 제공합니다. </p>
        </div>
      </div><!-- SECTION END: 콘텐츠 헤더 -->
      <!-- SECTION START: 서비스소개 -->
      <div class="section">
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">CDN</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/marketplace/network/img-u02-07-t02-v01-02.png">
              </div>
            </div>
            <ul class="list big-step grid">
              <li>
                <h4 class="label">B tv Live</h4>
                <div class="content">
                  <p>고객의 방송센터로부터 방송신호를 받아 B tv 방송 시스템의 신호를 바탕으로 고화질 인터넷방송을 송출을 지원합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">플랫폼 기술</h4>
                <div class="content">
                  <p>트래픽을 예측하기 어려운 UCC사이트나, 폭주하는 SNS 트래픽 처리에 용이한 플랫폼 기술(Unified Elastic Cache Platform)을 보유하고 있습니다. 서비스 중단 없이 손쉬운 사이트 확장 및 이벤트 처리가 가능합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">국내 최다 특허 보유</h4>
                <div class="content">
                  <p>SK Telecom과 공동으로 전문 CDN R&amp;D를 운영하고 있습니다. 국제특허 29건, 국내특허 105건 등 국내 최다 관련 특허를 보유하고 있습니다. 매년 고객 맞춤형 서비스 개발을 위해 지속적으로 R&amp;D 투자를 진행합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">실시간 모바일 인터넷 방송</h4>
                <div class="content">
                  <p>HTTP Live Streaming(HLS)기술의 단점인 지연 현상을 해소한 SK만의 저 지연 T Live Streaming 기술로 실시간 모바일 인터넷방송 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Telco 유일의 CDN 전문 R&amp;D 운영</h4>
                <div class="content">
                  <p>SK브로드밴드는 5년 연속 국가고객만족도 NCSI 1위의 고품질 초고속 Tier1급 인터넷 백본망과 국내 최대 모바일 백본을 운용하고 있습니다. OVP, AND과 같은 다양한 서비스 플랫폼을 개발하고 있습니다.</p>
                </div>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/network/img-u02-07-t02-01-08.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">비용 효과적</h4>
                    <p> 데이터 전송량에 따라 비용이 청구되므로<br /> 사용하지 않은 용량을 지불할 필요 없이 <br /> 사용자 요구사항을 충족 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco w-50p  top-left">
                    <img src="/assets/imgs/marketplace/network/img-u02-07-t02-01-09.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">효과적인 확장</h4>
                    <p> 지역별 수요 및 자원 이용률에 따라 <br /> 노드를 채우고 확장 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/network/img-u02-07-t02-01-10.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">보안</h4>
                    <p> 콘텐츠 관리 및 수익화를 위해 <br /> 간소화된 도구가 디지털 저작권을 보호 </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="content-box">
              ...
              <ul class="grid col-2">
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">T Live Streaming</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>실시간 고속 모바일 프로토콜은 TLS(True real-time Live Streaming)라는 SK 독자 기술을 사용하여 딜레이타임 문제를 해소 했습니다. 영상 전송 방식을 사용하여 개발되었으며, 3초 이내의 초 저지연 실시간 방송 제공과 더불어 모바일 네트워크에 최적화된 전송 기법 적용을 통해 50% 향상된 빠른 영상 시작 시간, 10%가 절감된 데이터 양, 동기간의 싱크 및 손실 복원 기술 등 향상된 품질을 제공 합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">Unified Elastic Cache</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>최근 통신 기술의 발전으로 고화질 영상 전송이 가능해졌고, 다양한 콘텐츠 소비 욕구를 충족시키기 위해 소비자와 생산자가 상호 작용하며 수많은 콘텐츠를 생산하고 소비하고 있습니다. 콘텐츠 소비 트렌드 변화에 효과적으로 대응하기 위해, 확장성이 높고 유연한 Cache 시스템을 제공합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">UEC(Unified Elastic Cache)</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>UEC는 통합 cache 관리와 콘텐츠 타입에 따른 로드 밸런스를 통해 Cache 히트율을 유지하면서 더 많은 자원 활용이 가능합니다.</li>
                        <li>문제 발생 시 절체를 통해 빠른 복구를 지원합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">Contents Aware Cache</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>콘텐츠 Aware Cache 솔루션은 기존 상용 Cache 서버에서는 지원되지 않는 콘텐츠 별 트래픽 최적화를 위한 솔루션입니다.</li>
                        <li>Open Source HTTP 서버를 활용하여 Application 레벨에서 콘텐츠 별 Throttling 기술, 콘텐츠 별 최적화 전송 기술, 그리고 콘텐츠 별 분산 기능을 지원합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
