...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main" data-page="management">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/management/header_01.png');">
      </div>
    ...
    <div class="entry-content">
      <div class="banner-card-wrap inner-wrap">
        <a href="/services/cloud-marketplace/management/high-availability" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/management/img-u02-07-t03-02.png" alt="high-availability">
          </div>
          <div class="text-box">
            <div class="title">고가용성</div>
            <div class="desc">Cloud 환경에서 다양한 운영체제와 애플리케이션의 <br />고가용성 및 재해복구를 지원합니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/management/zconverter-draas" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/management/img-u02-07-t01-03.png" alt="zconverter-draas">
          </div>
          <div class="text-box">
            <div class="title">Zconverter-DRaaS</div>
            <div class="desc">재해 발생 시 업무 중단 영향을 최소화할 수 있도록 OS/APP 재설치 없이<br />기존과 동일한 환경으로의 빠른 복구를 지원합니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/management/zconverter-backup" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/management/img-u02-07-t01-04.png" alt="zconverter-backup">
          </div>
          <div class="text-box">
            <div class="title">Zconverter-Backup</div>
            <div class="desc">데이터 손실을 방지하여 고객의 중요 데이터를 <br />가장 안전하게 백업하고 보관해주는 서비스입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/management/zconverter-cloud-migration" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/management/img-u02-07-t01-05.png" alt="zconverter-cloud-migration">
          </div>
          <div class="text-box">
            <div class="title">Zconverter-Cloud Migration</div>
            <div class="desc">고객이 운영 중인 물리/가상 서버를 Cloud Z VM으로 이전 시 <br />기존과 동일한 구성으로 신속하게 마이그레이션을 지원하는 서비스입니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/management/veritas-netbackup" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/management/img-u02-07-t01-06.png" alt="veritas-netbackup">
          </div>
          <div class="text-box">
            <div class="title">Veritas NetBackup</div>
            <div class="desc">데이터 손실을 방지하는 것을 최우선으로 하며 고객의 중요 데이터를<br />가장 안전하게 백업하고 보관해주는 서비스입니다.</div>
          </div>
        </a>
      </div>
    </div>
