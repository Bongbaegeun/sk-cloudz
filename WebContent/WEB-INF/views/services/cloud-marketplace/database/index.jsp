...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main" data-page="database">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/database/header_01.png');">
      </div>
    ...
    <div class="entry-content">
      <div class="banner-card-wrap inner-wrap">
        <a href="/services/cloud-marketplace/database/encryption" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/database/img-u02-07-t05-02.png" alt="encryption">
          </div>
          <div class="text-box">
            <div class="title">DB 암호화</div>
            <div class="desc">Cloud 환경에서 서비스되는 데이터를 보호하기 위해 암호화 키를 기반으로 한 <br />데이터 암호화 솔루션을 제공합니다.</div>
          </div>
        </a>
        <a href="/services/cloud-marketplace/database/access-control" class="banner-card has-corner-arrow">
          <div class="bg-block image">
            <img src="/assets/imgs/marketplace/database/img-u02-07-t05-03.png" alt="access-control">
          </div>
          <div class="text-box">
            <div class="title">DB 접근제어</div>
            <div class="desc">보안대상 DB에 대해 접근/권한 통제, SQL 감사 기록 등을 수행하며,<br />사용자별 작업 이력 감사 및 리포트를 제공합니다.</div>
          </div>
        </a>
      </div>
    </div>
