...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container sub">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/marketplace/database/header_02.png')"></div>
      <div class="bg-block dark-overay"></div>
      <header class="sub-header">
        <div class="inner-wrap">
          <h2>DB 암호화</h2>
          <p> Cloud 환경에서 서비스되는 데이터를 보호하기 위해 암호화 키를 기반으로 한 데이터 암호화 솔루션을 제공합니다. </p>
    ...
    <div class="entry-content">
        ...
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">DB 암호화</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-02.png">
              </div>
            </div>
            <div class="content-box">
              <h1>DB 암호화란?</h1>
              <p> DB 내에 저장된 데이터를 '해독이 불가능한 형식의 암호문으로 변환'하는 것을 의미합니다. 애플리케이션 - 시스템 - 네트워크, 3개 계층 모두 적절한 암호화가 적용되고 안전한 키 관리와 권한 관리 및 접근 제어를 통해 완벽한 암호화를 이룰 수 있습니다. </p>
            </div>
            <div class="content-box">
              <h1>DB암호화의 필요성</h1>
              <p> 외부 침입 및 내부자 불법행위에 의한 개인정보 유출 시도가 증가하고 있습니다. 비인가된 접근을 차단하는 것만으로는 데이터 보호를 위한 대책으로는 부족하며 근원적으로는 데이터 암호화를 통해 데이터 유출 방지가 가능합니다. 법률에 따른 개인정보 유출 방지가 강화되고 있습니다. (정보통신망법, 개인정보보호법, 신용정보의 이용 및 보호에 관한 법률) </p>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-03.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">강력한 암호화</h4>
                    <p> 국정원 검증필 암호모듈 탑재<br /> FIPS 인증 암호 알고리즘<br /> 국내외 표준 암호 알고리즘 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco w-50p  top-left">
                    <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-04.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">접근 제어</h4>
                    <p> White/Black List 관리<br /> 컬럼별/사용자별 권한 부여<br /> 로그인 접근제어 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-05.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">모든 DBMS 지원</h4>
                    <p> 모든 DBMS에 대한 암호화 제공<br /> Cloud Z 환경의 MariaDB, Tibero 완벽한 호환성 제공 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco w-50p  top-left">
                    <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-06.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">감사로그</h4>
                    <p> 중앙 집중형 로그 관리<br /> 접근/정책/상태 로그<br /> 로그 자동 백업 및 조회 </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p ">
                    <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-07.png">
                  </figure>
                  <div class="desc">
                    <h4 class="title">키 관리</h4>
                    <p> 국내외 암호화 표준을 준수한 안전한 키 관리<br /> D&rsquo;Amo, 외부 Application, TDE 키 관리 제공 </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="content-box">
              ...
              <ul class="grid col-2">
                <li class="grid-item">
                  <div class="content-item">
                    ...
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>암복호화를 애플리케이션에서 수행할 수 있습니다. </li>
                        <li>암호화 대상 DB서버의 부하를 분산 처리 기능을 제공합니다. </li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">인덱스 검색, 부분 암호화</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>인덱스 컬럼 암호화 후에도 기존의 인덱스 검색을 유지 할 수 있습니다. </li>
                        <li>암호화 후에도 인덱스 검색 기능을 지원 합니다. </li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">대용량 데이터 일괄 암호화</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>DB에서 파일 형태로 익스포트하여 파일을 암호화한 후 DB에 저장하는 방식으로, 빠른 속도를 보장 합니다. </li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="grid-item">
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">개발 편의 기능 제공</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>다양한 프로그래밍 언어 기반의 함수 및 라이브러리를 제공하여 개발 편의성을 향상 할 수 있습니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
      ...
      <div class="section">
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="content-box">
              <h1>D&rsquo;Amo Cloud</h1>
              <p> D&rsquo;Amo Cloud는 안전한 Cloud 암호화 환경 구성을 위해 Cloud 암호화 키관리 솔루션인 D&rsquo;Amo KMS V-Series를 중심으로 다양한 Cloud 시스템환경에 적용할 수 있는 D&rsquo;Amo Agent for Cloud를 제공합니다. Cloud Z 환경의 MariaDB, TiberoDB에 대해 강력한 암호화와 안전한 호환성을 제공하며, 키 관리 솔루션을 통해 D&rsquo;Amo 제품군의 키 관리 뿐만 아니라 외부 Application, TDE 키 관리를 제공합니다. </p>
              <div class="img-box mg-top-3x" style="height: 758px">
                <img src="/assets/imgs/marketplace/database/img-u02-07-t05_v01-08.png">
              </div>
            </div>
          </div>
        </div>
