      ...
      <div class="section">
        <div class="inner-wrap">
          <header class="section-header mg-0">
            <h2 class="title">고객 환경에 맞는 최적의 Managed Service를 선택할 수 있습니다.</h2>
            <p>Managed Service의 기본인 General Support를 기반으로, 더 정밀한 운영서비스가 Standard와 Premium 두 가지 옵션으로 제공됩니다.</p>
          </header>
        </div>
      </div>
      <div class="section">
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">IaaS MSP</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/sub/u0204/v01/01.png" alt="">
              </div>
            </div>
            <ul class="list big-step grid">
              <li>
                <h4 class="label">General Support</h4>
                <div class="content">
                  <p>Cloud 운영의 기본인 Billing, 각종 Report, 기술문의를 포함한 Request Management 서비스를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">모니터링</h4>
                <div class="content">
                  <p>Hybrid Monitoring 뿐 아니라 CSP Native Monitoring 포함한 통합 Dashboard 를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">운영 서비스</h4>
                <div class="content">
                  <p>Hybrid Monitoring 뿐 아니라 CSP Native Monitoring 포함한 통합 Dashboard 를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">최적화 서비스</h4>
                <div class="content">
                  <p>정기적인 성능분석 및 Resource Right Sizing을 통해 비용을 절감하고 늘 Well-Architecture를 유지합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Special Offer</h4>
                <div class="content">
                  <p>고객의 Cloud 환경 또는 준비 상황에 맞게 Cloud 기본 교육, 신기술 소개, DevOps, CI/CD 교육 서비스를 받으실 수 있습니다.</p>
                </div>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0204/v01/02.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">Multi-Cloud 운영<div>서비스 제공</div>
                    </h4>
                    <p>AWS, Azure, GCP, IBM 등 Multi-Cloud 영역별 전문가를 보유하여 고객이 Cloud를 통해 달성하고자 하는 비즈니스 목표를 이룰 수 있도록 최상의 서비스를 제공합니다.</p>
                    <p>Multi-Cloud 통합 대응 서비스를 연중 무휴 제공하며, 장애 영향도를 최소화할 수 있습니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco top-left w-50p">
                    <img src="/assets/imgs/sub/u0204/v01/03.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">고객 눈높이에 맞는<div>운영품질 확보</div>
                    </h4>
                    <p>Enterprise 고객의 다양한 서비스에 대한 높은 수준의 이해를 바탕으로 효율적인 통합 운영이 가능하며 Cloud Managed Service 경험을 전파하여 운영 효율성을 더욱 높일 수 있습니다.</p>
                    <p>Cloud 공급사와의 Premium Partnership을 보유한 Cloud Z를 통해 다양한 유형의 장애 발생 시 신속한 원인 파악 및 조치가 가능합니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0204/v01/04.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">자동화 통한<div>서비스 가용성 극대화</div>
                    </h4>
                    <p>운영자동화를 통해서 변화하는 Cloud 자원을 모니터링하고 운영 비용을 절약할 뿐만 아니라 장애 인지 및 해결 시간을 단축합니다.</p>
                    <p>빈번히 발생하는 구성 변경 시  필요한 작업 시나리오, 예측 가능한 장애 발생 시에 조치를 위한 자동화 시나리오를 준비하고 대응합니다.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="product-list vertical">
                <div class="product-list-item">
                  ...
                  <div class="product-list-content">
                    <ul class="list dot">
                      <li>업무 시간 내 Service Request 월 2회/4시간 지원</li>
                      <li>기본적인 모니터링, Dashboard, Event 전파 서비스 제공</li>
                      <li>최적화 연 1회 제공</li>
                    </ul>
                  </div>
                </div>
                <div class="product-list-item">
                  ...
                  <div class="product-list-content">
                    <ul class="list dot">
                      <li>24x7 통합 관리 및 Service Request 무제한</li>
                      <li>On/Off-Line 운영 Service Review</li>
                      <li>통합 Billing 및 예산 관리</li>
                      <li>모니터링, Dashboard, Event 전파 Customizing</li>
                      <li>최적화 반기 1회</li>
                      <li>Infra 자원에 대한 Provisioning, Resizing, Patch, Backup, Restore 이행 및 Reporting</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="content-box">
              <ul class="grid col-3">
                ...
                <li>
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">Monitoring &amp; 장애 대응</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>Planned Maintenance 관리</li>
                        <li>Incident &amp; 요청 사항 대응</li>
                        <li>Dashboard</li>
                      </ul>
                    </div>
                  </div>
                ...
                <li>
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">IaaS Mgmt.</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>Compute (VM, Storage, Bakcup 등)</li>
                        <li>Security (악성 웹트래픽 관리 등)</li>
                        <li>Network (Virtual NW/DNS/LB 관리 등)</li>
                        <li>Database (RDB, Backup 등)</li>
                      </ul>
                    </div>
                  </div>
                </li>
