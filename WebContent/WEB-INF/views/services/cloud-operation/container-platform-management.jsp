          ...
          <div class="section-body">
            ...
            <ul class="list big-step grid">
              ...
              <li>
                ...
                <div class="content">
                  <p>CSP 모니터링 도구 뿐만 아니라 Modernization Platform 모니터링을 추가하여 24x7 모니터링 및 Dashboard 서비스를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">이슈 대응 및 유지보수가 용이한 Container 관리</h4>
                <div class="content">
                  <p>CSP Native 또는 Modernization Platform Add-on으로 구성 된 CI/CD Pipeline, Git, Image Registry, Logging 사용 시 발생하는 이슈 대응 및 유지보수 서비스를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">사용자별 권한 관리 서비스</h4>
                <div class="content">
                  <p>Kubernetes Resource 및 Add-on 서비스 모두에 대한 사용자 권한관리가 가능합니다. Dashboard 및 Modernization Platform Console로 사용자별 권한 관리도 가능합니다. </p>
                </div>
              </li>
            </ul>
          </div>
