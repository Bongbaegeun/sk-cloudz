  ...
  <div class="container">
    <div class="entry-header">
      <header class="sub-header">
        <div class="inner-wrap">
          <h2>Journey to AWS Cloud</h2>
          <p>AWS Migration 방법론을 통한 비즈니스 및 기술 전략 수립 및 최적의 End-to-End Cloud 전환 수행 및 지원</p>
        </div>
        <div class="sub-bg">
      ...
      <div class="section">
        <div class="inner-wrap">
          <header class="section-header mg-0">
            <h2 class="title">고객의 다양한 환경을 고려하여 최적의 AWS Cloud 전환 여정을 제시합니다.</h2>
            <p>Enterprise 고객들이 IT 환경 변화에 따른 과제를 해결할 수 있도록, AWS Migration 방법론을 기반으로 그룹 멤버사, 대외 고객을 대상으로 진행하면서 확보한 경험과 노하우, Ref. Architectures, SK Tool을 적용하여 고객 환경에 맞는 최적의 서비스를 제공합니다.</p>
          </header>
        </div>
      </div>
      <div class="section">
        <div class="inner-wrap">
          ...
          <div class="section-body">
            <div class="key-visual">
              <div class="key-copy">
                <h4 class="copy">Journey to AWS Cloud</h4>
              </div>
              <div class="key-img">
                <img src="/assets/imgs/sub/u0201/v03/01.png" alt="">
              </div>
            </div>
            <ul class="list big-step grid">
              <li>
                <h4 class="label">Cloud 전환을 위한 고객 IT 분석/진단 Assessment</h4>
                <div class="content">
                  <p>AWS의 방법론(CAF, MRA)을 바탕으로 당사의 ITSM 경험 및 운영 Know-How를 반영한 ‘SK Methodology’를 적용합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">Well-Architecture 기반<br>Cloud 전환 설계 및 Planning</h4>
                <div class="content">
                  <p>최신의 기술 반영은 물론, Public Cloud Architecture Design<br>5 Principles (성능 효율성, 안정성, 보안, 운영 우수성, 비용 최적화)를 적용하여 설계합니다.</p>
                  <p>그룹 멤버사의 사업 영역별 Ref. Architecture를 제공합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">전문 기술 인력 기반의 안전한 Migration 수행</h4>
                <div class="content">
                  <p>Cloud 전환을 위한 AWS SA외 DB Migration, Security 및 Cloud Native DevOps 등 Application Modernization을 위한 기술전문가와 함께 Migration을 수행합니다.</p>
                </div>
              </li>
              <li>
                <h4 class="label">고객의 Cloud Adaption Level에 맞는 Governance 체계 선제적 제안</h4>
                <div class="content">
                  <p>Enterprise 고객이 복잡한 IT 환경을 체계적으로 통합/관리할 수 있도록, Cloud 도입, Biz Agile 확보 및 대규모 Migration등 고객의 요건과 향후 확장을 고려한 Cloud Governance 체계를 설계하고 선제적으로 제시합니다.</p>
                </div>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0201/v03/02.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">AWS Cloud 환경으로의 유연한 전환</h4>
                    <p>컨설팅, 설계, 구축까지 하나의 흐름으로 Migration을 성공적으로 수행할 수 있습니다. </p>
                    <p>추후 구성될 운영 및 Appl.을 고려한 전환이 가능합니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content inverse">
                  <figure class="deco top-left w-50p">
                    <img src="/assets/imgs/sub/u0201/v03/03.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">Hybrid-Cloud 구조로 전환 설계 및 구축 가능</h4>
                    <p>고객의 상황을 고려해 On-premise는 물론 AWS/Azure/GCP 등 다양한 Cloud와의 Hybrid 구조로 설계/구축이 가능합니다.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="row-content">
                  <figure class="deco w-50p">
                    <img src="/assets/imgs/sub/u0201/v03/04.png" alt="">
                  </figure>
                  <div class="desc">
                    <h4 class="title">특정 시스템에 대한 전환도<br>전문적으로 수행</h4>
                    <p>Data Lake, 보안, Network 전문성 및 다양한 프로젝트 경험을 보유한 전문가들을 보유 하고 있습니다.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="content-box">
              <ul class="grid col-2">
                <li>
                  <div class="content-item">
                    ...
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>AWS 방법론(CAF: Cloud Adaption Framework, MAP: Migration Acceleration Program) 및 자동화 도구를 활용하면서, Enterprise에서 필요로 하는 ITSM 경험, 운영 Knowhow를 반영한 SK Methodology를 개발하여 Asset化 하였습니다.</li>
                        <li>SK Methodology는 Cloud와 전통적인 IT운영 관리의 차이를 해소 하여 통합관리를 지원합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">Well-Architecture 기반 Cloud 전환 설계 및 Planning</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>Hybrid/Multi-Cloud의 통합 관점, Cloud Operation, Appl. Modernization을 위한 Architecting/Migration 서비스를 제공합니다.</li>
                        <li>On-Premise 환경, Multi Cloud 환경을 고려하여 각 Layer(IaaS, PaaS, Security, Network, DB 등)에 최적인 Cloud Architecture 설계를 진행합니다.</li>
                        <li>전환대상의 Cloud Operation 및 Appl. Modernization을 위한 AWS Native 서비스를 활용, Migration Planning을 구체화 합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="content-item">
                    ...
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>Migration 단계에서는 Planning이 완벽 했다고 하더라도 수행과정에서 많은 변수와 예상치 못한 이슈들이 발생하게 됩니다.</li>
                        <li>Cloud Z에서는 대용량 Database, Cloud Native DevOps, MSA, K8S 등 Cloud 기술 전문가와 고객의 기업환경에 대해 높은 이해도를 가진 기업 시스템 전문가를 함께 투입하여 보다 신속하고 정확하게 구현할 수 있습니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="content-item">
                    <div class="content-item-header">
                      <h4 class="label">고객의 Cloud Adaption Level에 맞춰 Governance 체계 선제적 제안</h4>
                    </div>
                    <div class="content-item-body">
                      <ul class="list dot">
                        <li>고객의 Cloud Adaption Level을 Cloud 전환 목표와 연계하여 쉽고 편리하게 Cloud 환경을 운영할 수 있는 Governance 체계를 제안하고 있습니다.</li>
                        <li>이를 위해 ITSM 관리체계를 결합한 Security &amp; Compliance Control, Cloud 자원관리, Data/Network Control, 공통 영역(Shared) 관리 가이드와 정책의 컨설팅, 중앙 관리 체계를 위한 자동화된 AWS Landing Zone/Control Tower, SK Landing Zone 서비스를 제공합니다.</li>
                      </ul>
                    </div>
                  </div>
                </li>
          ...
          <div class="section-body">
            <div class="content-box x-axis">
              <div class="row content-row">
                ...
                <div class="row-content">
                  <ul class="list dot">
                    <li>고객사는 BM 혁신에 대응이 가능한 시스템 구조설계 및 고객향 프로세스 혁신 및 디지털化를 지향하고 있습니다.</li>
                    <li>민첩한 서비스를 위해 Cloud로의 변화까지 고민하고 있었습니다.</li>
                  </ul>
                </div>
                ...
                <div class="row-content">
                  <ul class="list dot">
                    <li>민첩하고 유기적인 시스템 구조 설계 및 노후한 시스템을 혁신하는 것을 목표로 차세대 Cloud Migration 프로젝트를 수행하였습니다. 또한 시스템 구조설계에 대한 전문성을 가지고 안정적으로 Cloud로 전환하는 것이 매우 중요하였습니다.</li>
                  </ul>
                  <div class="fill-box w-100p">
                    <ul class="list dot">
                      <li>당사 전문가들을 투입하여 초기 컨설팅부터 전체적인 관점으로 구조설계의 틀을 수립하였습니다.</li>
                      <li>설계를 바탕으로 차세대 시스템 구축까지 지원하였으며 그 여정을 체계적으로 안내하였습니다.</li>
                    </ul>
                  </div>
                </div>
                <div class="deco-line"></div>
                ...
                <div class="row-content">
                  <ul class="list dot">
                    <li>사업의 완성도와 민첩성/안전성을 확인한 고객사는 차세대 프로젝트에 대해 매우 만족하고 있으며, 추가적으로 차세대와 연동이 가능한 시스템에 대해 추가 전환까지 고려하고 있습니다.</li>
                  </ul>
                </div>
              </div>
              <div class="row">
