...
<head>
  ...
  <link rel="stylesheet" href="/assets/customerstory/main.css">
</head>
...
<body class="scroll-top fixed-gnb">
  ...
  <div class="container main">
    <div class="entry-header">
      <div class="bg-block image" style="background-image: url('/assets/imgs/customerstory/header_01.png')"></div>
      <div class="bg-block dark-overay"></div>
      <header class="sub-header">
        <div class="inner-wrap d-flex centered">
  ...
  <script src="/assets/lib/vue-lib.min.js"></script>
  <script src="/assets/customerstory/app.js"></script>
